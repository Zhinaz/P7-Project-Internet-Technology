...
% ¤¤ Referencer ¤¤
\newcommand{\phone}{control interface}
\newcommand{\Phone}{Control Interface}
\newcommand{\phones}{control interfaces}
\newcommand{\Phones}{Control Interfaces}
\newcommand{\hub}{central hub}
\newcommand{\Hub}{Central Hub}
\newcommand{\sdev}{smart device}
\newcommand{\SDev}{Smart Device}
\newcommand{\Sdev}{Smart device}
\newcommand{\sdevs}{smart devices}
\newcommand{\SDevs}{Smart Devices}
\newcommand{\Sdevs}{Smart devices}
...
%% Coloured Text Box %%
\mdfdefinestyle{colbox-style}{%
linecolor=aaublue,outerlinewidth=1pt,%
frametitlerule=true,frametitlefont=\sffamily\bfseries\color{white},%
frametitlerulewidth=1pt,frametitlerulecolor=aaublue,%
frametitlebackgroundcolor=aaublue,
backgroundcolor=aaublue!5,
innertopmargin=\topskip,
roundcorner=5pt
}
\newmdenv[style=colbox-style]{exa}
\newenvironment{colbox}[1]
  {\begin{minipage}{\textwidth}\begin{narrow}{1cm}{1cm}\begin{exa}[frametitle=#1]}
  {\end{exa}\end{narrow}\end{minipage}}
